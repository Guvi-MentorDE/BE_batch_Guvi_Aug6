...
load data local inpath '${hiveconf:file_path}' into table emp_raw_daily_table;

--- final master table -----
create external table if not exists emp_master 
(emp_name string,
sal int
) 
...
insert overwrite table emp_master
